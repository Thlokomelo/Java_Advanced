...
public class ProductCounter {
    ...
    // Create a Counting Map (added)
    private Map<String, Long> productCountMap = new HashMap<>();

    // Create a Name Mapping Map (added)
    ...
    public static void main(String[] args) {
        ...
        // Create Product Counter Object and process data (added)
    ...
    public ProductCounter(Map productNames) {
        // One argument constructor that accepts a Map as a parameter
        this.productNames = productNames;
    }

    public void processList(String[] list) {  //Added a method processes a list of String part numbers
                                             //HashMap used to store the current count based on the part number
        long curVal = 0;
