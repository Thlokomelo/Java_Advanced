...
// Create several customers and their accounts
        ...
        bank.addCustomer("Jane", "Simms");                 //added customer
        customer = bank.getCustomer(2);
        customer.addAccount(new CheckingAccount(200.00,
                400.00));

        bank.addCustomer("Owen", "Bryant");                //added customer
        customer = bank.getCustomer(3);
        customer.addAccount(new CheckingAccount(200.00));

        bank.addCustomer("Tim", "Soley");                  //added customer
        customer = bank.getCustomer(4);
        customer.addAccount(new CheckingAccount(200.00));

        bank.addCustomer("Maria", "Soley");               //added customer
