...
public class CollectTest {
    ...
    public static void main(String[] args) {
        ...
        //Filter the transaction list to only include transactions greater than $300,000 sorted in Filter the transaction list to only include transactions greater than $300,000 sorted in asc order
        rList = tList.stream()
